  ...
  <div class="container-fluid">
    ...
    <div id="loginbox">
      ...
      <div class="outerbox">
        ...
        <form id="loginform" class="form-vertical" method="post" action="/dashboard">
          <div class="control-group normal_text"><div class="height30"></div> <h3> <img src="images/images_backend/logo.png" alt="Logo" /></h3></div>
